...
export const LEDGER_SCORES: LedgerScoreEntry[] = [
  ...
  entry(
    ...
    'QBTS',
    true,
    { tech: 50, capital: 76, commercial: 76, government: 35 },
    'Largest Q1 2026 revenue beat in the cohort ($15M, +509% YoY); first US university owned-system sale to FAU. Guidance raised.',
    {
      ...
      capital: 'Cash position rebuilt to ~$325M post-2025 ATM and registered direct offerings. FY26 guidance raised to $80–95M (from $70–85M) after Q1 beat.',
      commercial: 'Q1 2026 revenue $15.0M (+509% YoY); $20M FAU system sale (first US university to own rather than rent a full quantum system). FY25 revenue $24.6M (+179%). NatWest deployed.',
  ...
  entry(
    ...
    'INFQ',
    true,
    { tech: 68, capital: 72, commercial: 62, government: 42 },
    'Only US-listed neutral-atom pure-play with a real sensing revenue line funding the compute bet; FY26 guide of $40M sets the cohort benchmark.',
    {
      tech: 'Strontium neutral-atom computing + quantum sensing/PNT + atomic clocks. 99.73% CZ gate fidelity record (Oct 2025). Royal Navy submarine quantum optical clock deployment is the first defense-grade quantum-sensing field application. Roadmap targets logical qubits via dual-species architecture.',
      capital: 'NYSE-listed January 2026 via Churchill Capital Corp X SPAC merger at ~$1.8B enterprise value; ~$540M gross proceeds funded the runway. Current market cap ~$720M (post-SPAC compression).',
      commercial: 'FY26 revenue guidance $40M (the highest published guide for any neutral-atom name). FY25 revenue ~$29M. $200M+ customer pipeline disclosed. NVIDIA partner. Sensing/clock revenue line is real today.',
      government: 'Heavy DoD/IC exposure via SAIC investor. DARPA QBI Stage A only — not on Stage B list. Royal Navy contract is the first allied procurement signal.',
    },
    'up',
    'Sensing/PNT becomes $100M+ business by 2027 on AUKUS/DoD wins; only US-listed neutral-atom pure-play; cleanest unit economics in the cohort and free optionality on the neutral-atom compute bet.',
    'Post-SPAC vintage trading compressed (~$720M cap vs ~$1.8B deal); crowded neutral-atom field (Atom, QuEra, Pasqal); defense procurement cycles are long and public investors lose patience.',
  ),
  ...
  // ===== Pass 3 (May 2026): coverage completion =====
  ...
  entry(
    ...
    undefined,
    false,
    { tech: 70, capital: 78, commercial: 75, government: 50 },
    ...
    {
      tech: 'OPX1000 multi-modality quantum control hardware + Pulse Suite software stack. Hardware-agnostic — runs underneath superconducting, ion, atom, photonic, and NV experiments.',
      capital: '~$170M total raised. NVIDIA collaboration on hybrid quantum-classical orchestration. Israeli-anchored cap table.',
      commercial: '~280 deployments across academic labs, national labs, and corporate research teams. Estimated revenue range from third-party tracking suggests largest commercial revenue among quantum control vendors. Reseller relationships with multiple modalities.',
      government: 'Deployed at multiple DOE QIS centers, AFRL, and DARPA-funded labs but not a direct QBI program participant.',
    },
    'up',
  ...
  entry(
    ...
    undefined,
    false,
    { tech: 58, capital: 50, commercial: 30, government: 55 },
    'French photonic quantum vendor with indistinguishable-single-photon source IP — niche but European-sovereign-backed.',
    {
      tech: 'Photonic platform built on Quandela\'s indistinguishable-single-photon sources. 3- and 6-photon experiments published. Ascella cloud platform for application development. FTQC roadmap less detailed than PsiQuantum or Xanadu.',
      capital: '~$80M cumulative raised through 2024–2025. French government PROQCIMA program backing. OVHcloud strategic relationship.',
      commercial: 'Cloud access via Ascella; some on-prem deployments at European HPC centers. Revenue scale not publicly disclosed.',
      government: 'France 2030 PROQCIMA finalist. EU Quantum Flagship participant. Not in DARPA QBI Stage A or B.',
    },
    'flat',
  ...
  entry(
    ...
    undefined,
    false,
    { tech: 62, capital: 75, commercial: 55, government: 30 },
    ...
    {
      tech: 'Wukong 72-qubit superconducting platform; updated processors disclosed through 2024–2025 with published fidelities that have not been independently verified by Western benchmarking bodies. Domestic FTQC roadmap parallels the US/EU cohort.',
      capital: 'State-backed via Hefei National Lab and Chinese strategic-emerging-industries funding. Capital access is not the constraint.',
      commercial: 'Reported domestic revenue in the tens of millions of USD equivalent; customer base anchored on Chinese national labs, ministries, and state-affiliated enterprises. Limited Western customer access.',
      government: 'Anchor of China\'s state quantum strategy; outside the DARPA / EU / AUKUS framework that organizes the rest of this score and is therefore scored conservatively on government dimension despite domestic backing.',
    },
    'flat',
  ...
  entry(
    ...
    undefined,
    false,
    { tech: 48, capital: 45, commercial: 25, government: 55 },
    'NV-diamond room-temperature niche play — smaller TAM but unique form factor that could matter for edge deployment.',
    {
      tech: 'Nitrogen-vacancy diamond qubits operating at room temperature. 5-qubit cards demonstrated; scale far behind cryogenic platforms but uniquely portable.',
      capital: '~AUD $20M Series A and follow-on. Quantonation, Main Sequence Ventures, Investible backers.',
      commercial: 'Pre-revenue at meaningful scale; pilot deployments and educational kits.',
      government: 'Australian National Quantum Strategy beneficiary; AUKUS-adjacent through Australian-side activity. Not a DARPA QBI participant.',
    },
    'flat',
